...
import type { ExternalBlob as _ExternalBlob, Time as _Time, WoundEntry as _WoundEntry, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addWoundEntry(arg0: ExternalBlob, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addWoundEntry(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWoundHistory(): Promise<Array<WoundEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWoundHistory();
...
async function from_candid_WoundEntry_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WoundEntry): Promise<WoundEntry> {
...
async function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        questionnaireResponses: value.questionnaireResponses,
        contentType: value.contentType,
        generatedReport: value.generatedReport,
...
async function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WoundEntry>): Promise<Array<WoundEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_WoundEntry_n10(_uploadFile, _downloadFile, x)));
}
